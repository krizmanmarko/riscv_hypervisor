...
#define HEDELEG_INSTRUCTION_ADDR_MISALIGNED EDELEG_INSTRUCTION_ADDR_MISALIGNED
#define HEDELEG_INSTRUCTION_ACCESS_FAULT EDELEG_INSTRUCTION_ACCESS_FAULT
#define HEDELEG_ILLEGAL_INSTRUCTION EDELEG_ILLEGAL_INSTRUCTION
#define HEDELEG_BREAKPOINT EDELEG_BREAKPOINT
#define HEDELEG_LOAD_ADDR_MISALIGNED EDELEG_LOAD_ADDR_MISALIGNED
#define HEDELEG_LOAD_ACCESS_FAULT EDELEG_LOAD_ACCESS_FAULT
#define HEDELEG_STORE_OR_AMO_ADDRESS_MISALIGNED EDELEG_STORE_OR_AMO_ADDRESS_MISALIGNED
#define HEDELEG_STORE_OR_AMO_ACCESS_FAULT EDELEG_STORE_OR_AMO_ACCESS_FAULT
#define HEDELEG_ECALL_FROM_U EDELEG_ECALL_FROM_U
#define HEDELEG_ECALL_FROM_S EDELEG_ECALL_FROM_S
#define HEDELEG_ECALL_FROM_M EDELEG_ECALL_FROM_M
